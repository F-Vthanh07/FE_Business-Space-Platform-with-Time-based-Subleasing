...
const translations: Translations = {
  ...
  // Wallet
  'wallet.title': { en: 'Wallet', vi: 'Ví của tôi' },
  'wallet.subtitle': { en: 'Manage your balance and payment methods', vi: 'Quản lý số dư và phương thức thanh toán' },
  'wallet.currentBalance': { en: 'Current Balance', vi: 'Số dư khả dụng' },
  'wallet.pendingBalance': { en: 'Pending Balance', vi: 'Số dư đang xử lý' },
  'wallet.totalDeposited': { en: 'Total Deposited', vi: 'Tổng đã nạp' },
  'wallet.totalSpent': { en: 'Total Spent', vi: 'Tổng đã chi' },
  'wallet.deposit': { en: 'Deposit', vi: 'Nạp tiền' },
  'wallet.withdraw': { en: 'Withdraw', vi: 'Rút tiền' },
  'wallet.viewHistory': { en: 'Transaction History', vi: 'Lịch sử giao dịch' },
  'wallet.recentTransactions': { en: 'Recent Transactions', vi: 'Giao dịch gần đây' },
  'wallet.viewAll': { en: 'View all', vi: 'Xem tất cả' },
  'wallet.walletId': { en: 'Wallet ID', vi: 'Mã ví' },
  'wallet.linkedAccount': { en: 'Linked Account', vi: 'Tài khoản liên kết' },
  'wallet.noTransactionsYet': { en: 'No transactions yet', vi: 'Chưa có giao dịch nào' },
  ...
  'wallet.deposit.methodLabel': { en: 'PAYMENT METHOD', vi: 'PHƯƠNG THỨC THANH TOÁN' },
  'wallet.deposit.summary': { en: 'Summary', vi: 'Tóm tắt' },
  'wallet.deposit.amount': { en: 'Amount', vi: 'Số tiền nạp' },
  'wallet.deposit.fee': { en: 'Transaction fee', vi: 'Phí giao dịch' },
  ...
  'wallet.history.searchPlaceholder': { en: 'Search by transaction ID or note...', vi: 'Tìm theo mã giao dịch hoặc ghi chú...' },
  'wallet.history.all': { en: 'All', vi: 'Tất cả' },
  'wallet.history.deposit': { en: 'Deposits', vi: 'Nạp tiền' },
  'wallet.history.payment': { en: 'Payments', vi: 'Thanh toán' },
  'wallet.history.payout': { en: 'Payouts', vi: 'Chi trả' },
  'wallet.history.refund': { en: 'Refunds', vi: 'Hoàn tiền' },
  'wallet.history.colTransaction': { en: 'Transaction', vi: 'Giao dịch' },
  'wallet.history.colDate': { en: 'Date', vi: 'Ngày' },
  'wallet.history.colMethod': { en: 'Method', vi: 'Phương thức' },
  'wallet.history.colAmount': { en: 'Amount', vi: 'Số tiền' },
  'wallet.history.colStatus': { en: 'Status', vi: 'Trạng thái' },

  'wallet.status.success': { en: 'Success', vi: 'Thành công' },
  'wallet.status.pending': { en: 'Pending', vi: 'Đang xử lý' },
  'wallet.status.failed': { en: 'Failed', vi: 'Thất bại' },

  'wallet.txn.depositLabel': { en: 'Wallet Deposit', vi: 'Nạp tiền vào ví' },
  'wallet.txn.paymentLabel': { en: 'Booking Payment', vi: 'Thanh toán đặt lịch' },
  'wallet.txn.payoutLabel': { en: 'Revenue Payout', vi: 'Chi trả doanh thu' },
  ...
  'wallet.payment.amount': { en: 'Amount', vi: 'Số tiền' },
  'wallet.payment.date': { en: 'Date & Time', vi: 'Thời gian' },
  'wallet.payment.method': { en: 'Payment Method', vi: 'Phương thức' },
  'wallet.payment.reason': { en: 'Reason', vi: 'Lý do' },
  'wallet.payment.reasonGeneric': { en: 'The payment gateway declined this transaction.', vi: 'Cổng thanh toán đã từ chối giao dịch này.' },
  'wallet.payment.backToWallet': { en: 'Back to Wallet', vi: 'Về trang Ví' },
  'wallet.payment.tryAgain': { en: 'Try Again', vi: 'Thử lại' },
  'wallet.payment.backHome': { en: 'Back to Home', vi: 'Về trang chủ' },
  'wallet.payment.viewReceipt': { en: 'View Receipt', vi: 'Xem biên lai' },
  'wallet.payment.contactSupport': { en: 'Contact Support', vi: 'Liên hệ hỗ trợ' },
};
